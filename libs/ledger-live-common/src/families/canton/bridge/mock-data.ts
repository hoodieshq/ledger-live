/* eslint-disable */
import { AccountTxResponse, BoilerplateOperation, AccountInfoResponse } from "@ledgerhq/coin-canton/network/types";

// Helper function to generate mock Canton transactions
...
export const getMockedMethods = (): {
  ...
  answer: any;
    ...
    // Empty transactions for new account
    {
      ...
      answer: [] as BoilerplateOperation[],
    },
